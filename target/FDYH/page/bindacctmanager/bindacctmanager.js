...
Ext.application({
	...
	launch : function() {
		...
		var gridStore = Ext.create('Ext.data.Store', {
			autoLoad : false,
			fields : ['branchid','branch.branchname','accountid','accountname','accounttype','submitid','submitdate','binds','branch'],
			pageSize:15,
			proxy : {
				type : 'ajax',
				actionMethods:{
					...
					handler:function(){
						if(editForm.getForm().isValid()){
							...
							editForm.getForm().submit({
								url:editAction==true?'../../action/BaseAccount/updateBindAndAcct':'../../action/BaseAccount/addBindAndAcct',
								params:{
									bindlist:bindlist,
									accountid:accountid
								},
						...
						fn:function(btn, text){
							if (btn == 'ok'){
						    	var request=Ext.Ajax.request({
									...
									url:'../../action/BaseAccount/deleteBindAndAcct',
